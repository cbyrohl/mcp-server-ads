...
async def test_library_list(mock_ctx, mock_httpx):
    ...
    mock_httpx.get("/v1/biblib/libraries").mock(return_value=httpx.Response(200, json=fixture))
...
async def test_library_delete(mock_ctx, mock_httpx):
    mock_httpx.delete("/v1/biblib/documents/abc123").mock(return_value=httpx.Response(200, json={}))
